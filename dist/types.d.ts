...
export type CmsMarkdownWidgetButton = "bold" | "italic" | "code" | "link" | "heading-one" | "heading-two" | "heading-three" | "heading-four" | "heading-five" | "heading-six" | "quote" | "code-block" | "bulleted-list" | "numbered-list";
...
export type CmsField = CmsFieldBase & (CmsFieldBoolean | CmsFieldCode | CmsFieldColor | CmsFieldDateTime | CmsFieldFileOrImage | CmsFieldList | CmsFieldMap | CmsFieldMarkdown | CmsFieldNumber | CmsFieldObject | CmsFieldRelation | CmsFieldSelect | CmsFieldHidden | CmsFieldStringOrText | CmsFieldMeta);
